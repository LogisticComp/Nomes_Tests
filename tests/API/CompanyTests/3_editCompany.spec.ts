...
import { addedCompanyData, urlCompany } from "../../../pages/companyPage";
import { generateRequestDataEditCompany } from "../../../pages/companyPage";
import { testWithFixture } from "../../../fixtures/fixtures";

let requestData = generateRequestDataEditCompany();

//export default function EditCompany(){
testWithFixture.describe.configure({ mode: "serial"});
testWithFixture.describe('Editing Company Tests', () => {
    testWithFixture("Edit Company", async ({ authorisedRequest, apiData, addedCompanyData}) =>{
        const response = await authorisedRequest.put(`${apiData.mainUrl}${urlCompany.companyUrl}/${addedCompanyData.addedcompanyId}`, {
            data: requestData,
    });
